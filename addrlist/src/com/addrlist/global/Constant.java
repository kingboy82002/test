...
public class Constant {
    ...
    //cookies
    public static final String USERNAMECOOKIE = "adderlistName";
    public static final String USERPASSWORDCOOKIE = "adderlistPassword";
    public static final String USERPASSWORDREMEMBERCOOKIE = "adderlistremember";
